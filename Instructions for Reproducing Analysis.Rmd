...
Clone this repository to your local machine using the following command in your terminal or Git Bash:

git clone https://github.com/Mohsnmonji/Inequalities-in-Young-Adults-Mental-Health-in-Canada.git


All necessary R scripts will be included in the cloned repository.
...
2.Move the `gss2017.csv` file to the main directory of the cloned repository (where the R scripts are located).
